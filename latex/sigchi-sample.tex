...
\title{Register Packing in Software}

\numberofauthors{3}
\author{
  \alignauthor Bing Schaefer\\
    \affaddr{University of Michigan}\\
    \email{bingscha@umich.edu}
  \alignauthor Ben Stoler\\
    \affaddr{University of Michigan}\\
    \email{stolerbs@umich.edu}
  \alignauthor Will Wendorf\\
    \affaddr{University of Michigan}\\
    \email{willwend@umich.edu}
}
